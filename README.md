...
| [OÍDA](https://github.com/sonicfieldlabs/oida) | 0.9.0 / `oida/gateway/v0.5` | Reference producer. OÍDA returns route decisions before content and can persist a pre-capture refusal without fabricating audio. |
